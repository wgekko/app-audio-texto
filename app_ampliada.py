...
# Mostrar transcripción actual y descarga
...
if st.session_state.historial:
    ...
    selected_item = st.selectbox(
        "Selecciona una grabación anterior",
        options=[item["nombre"] for item in st.session_state.historial]
    )
